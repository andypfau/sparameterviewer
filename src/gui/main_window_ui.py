...
class MainWindowUi(QMainWindow):
    ...
    def __init__(self):
        ...
        self._ui_slice_button = QtHelper.make_toolbutton(self, None, self.on_show_slicer, icon='toolbar_slice.svg', tooltip='Show a slicer to quickly select files by group', checked=False)
        ...
        self._ui_save_expr_button.setSizePolicy(QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed))
        ...
        self._ui_load_expr_button.setSizePolicy(QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed))
