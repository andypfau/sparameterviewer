...
class MainWindow(MainWindowUi):
    ...
    def __init__(self, filenames: list[str]):
        ...
        self.initially_apply_settings_to_ui_or_reset()
    ...
    def initially_apply_settings_to_ui_or_reset(self):
        try:
    ...
    def on_plottype_changed(self):
        ...
        Settings.tdr_dc_assumption = self.ui_plot_selector.tdExtrapolationDcAssumption()
    ...
    def update_plot(self, figure: matplotlib.figure.Figure = None):
        ...
        try:
            ...
            tdr.dc_assumption = None if self.ui_plot_selector.tdExtrapolationDcAssumption()=='none' else self.ui_plot_selector.tdExtrapolationDcAssumption()
