...
class PlotSelector(QWidget):
    ...
    def __init__(self, parent = None):
        ...
        self._ui_td_extrap_meth_menuwidget = QtHelper.add_menu_action(self._menu, QtHelper.layout_widget_h('DC Extrap.:', self._ui_td_extrap_meth_combo, ..., margins=(-1,-1,-1,0)))
        ...
        self._ui_td_extrap_dc_asmp_menuwidget = QtHelper.add_menu_action(self._menu, QtHelper.layout_widget_h('DC Assump.:', self._ui_td_extrap_dc_asmp_combo, ..., margins=(-1,-1,-1,0)))
        self._ui_td_interp_check = QCheckBox('Interpolate')
        self._ui_td_interp_check.stateChanged.connect(self._on_change_interp)
        self._ui_td_interp_menuwidget = QtHelper.add_menu_action(self._menu, QtHelper.layout_widget_h(self._ui_td_interp_check, ..., margins=(-1,-1,-1,0)))
        ...
        self._ui_td_window_menuwidget = QtHelper.add_menu_action(self._menu, QtHelper.layout_widget_h('Window:', self._ui_td_window_combo, ..., margins=(-1,-1,-1,0)))
