...
class PygubuAppUI:
    def __init__(self, master=None):
        ...
        self.log_text = tk.Text(
            self.scrollbarhelper4.container,
            name="log_text")
        ...
        self.frame4.pack(expand=True, fill="both", padx=5, pady=5, side="top")
        ...
        self.frame5.pack(expand=True, fill="x", padx=5, pady=5, side="bottom")
