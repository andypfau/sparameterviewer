...
class SparamviewerPygubuApp:
    def __init__(self, master=None):
        ...
        self.combobox_c1.bind('<<ComboboxSelected>>', self.on_sel_trace1, add='')
        ...
        self.combobox_c2.bind('<<ComboboxSelected>>', self.on_sel_trace2, add='')
        self.checkbutton_auto_cursor = ttk.Checkbutton(self.labelframe1)
        self.var_auto_cursor = tk.StringVar(value='')
        self.checkbutton_auto_cursor.configure(offvalue='manual', onvalue='auto', text='Auto', variable=self.var_auto_cursor)
        ...
        self.var_auto_trace = tk.StringVar(value='')
        self.checkbutton_auto_trace.configure(offvalue='manual', onvalue='auto', text='Auto', variable=self.var_auto_trace)
        ...
        self.radiobutton_c1.configure(text='Cursor 1', value='cursor_1', variable=self.var_selected_cursor)
        ...
        self.radiobutton_c2.configure(text='Cursor 2', value='cursor_2', variable=self.var_selected_cursor)
        ...
        self.scrollbarhelper2 = ScrollbarHelper(self.labelframe2, scrolltype='both')
        ...
        self.labelframe2.configure(height='200', padding='5', text='Readouts', width='200')
