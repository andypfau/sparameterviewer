...
class SparamviewerPygubuApp:
    def __init__(self, master=None):
        ...
        self.combobox_files.bind('<<ComboboxSelected>>', self.on_change, add='')
        ...
        self.spinbox_1.configure(from_='1', increment='1', textvariable=self.port, to='99')
        self.spinbox_1.configure(width='5')
        self.spinbox_1.pack(padx='0', side='left')
        self.labelframe_1.configure(height='200', padding='5', text='File and Port', width='200')
        ...
        self.labelframe_2.configure(height='200', padding='5', text='Integration Range', width='200')
        ...
        self.labelframe_3.configure(height='200', padding='5', text='Target Range', width='200')
        ...
        self.err_msg = tk.StringVar(value='')
        ...
        self.labelframe_4.configure(height='200', padding='5', text='Output', width='200')
        ...
        self.toplevel_rl.title('Return Loss Optimizer')
